...
/**
 * 中文转 拼音大些
 * android 4.2.2 系统源码抽取
 * Created by tangJ on 2017/11/13
 */
class HanziToPinyin private constructor(hasChinaCollator: Boolean) {


  private var mHasChinaCollator: Boolean = hasChinaCollator
  ...
  companion object {
    ...
    var DEBUG = false
    val TAG = "HanziToPinyin"


    /**
     * First and last Chinese character with known Pinyin according to zh collation
     */
    private val FIRST_PINYIN_UNIHAN = "\u963F"
    private val LAST_PINYIN_UNIHAN = "\u9FFF"
     ...
     */
    val UNIHANS = charArrayOf('\u963f', '\u54ce', '\u5b89', '\u80ae', '\u51f9', '\u516b', '\u6300',
        '\u6273', '\u90a6', '\u52f9', '\u9642', '\u5954', '\u4f3b', '\u5c44', '\u8fb9', '\u706c',
        '\u618b', '\u6c43', '\u51ab', '\u7676', '\u5cec', '\u5693', '\u5072', '\u53c2', '\u4ed3',
        '\u64a1', '\u518a', '\u5d7e', '\u66fd', '\u66fe', '\u5c64', '\u53c9', '\u8286', '\u8fbf',
        '\u4f25', '\u6284', '\u8f66', '\u62bb', '\u6c88', '\u6c89', '\u9637', '\u5403', '\u5145',
     ...
     */
    val PINYINS = arrayOf(byteArrayOf(65, 0, 0, 0, 0, 0), byteArrayOf(65, 73, 0, 0, 0, 0),
    ...
    private fun getInstance(): HanziToPinyin {
     ...
     * 获取 拼音 连接
     */
    fun getSpelling(input: String): String {
      return getInstance()[input].joinToString(separator = "", transform = { it.target ?: "" })
    }
  }
}